...
export default function ForgotPasswordPage() {
      ...
      <div className="space-y-6">
        <div className="text-center py-8 animate-scale-in">
          ...
          <p className="text-muted text-sm mb-8 max-w-xs mx-auto">
            If an account exists for <span className="font-medium text-secondary">{email}</span>, we&apos;ve sent a password reset link.
          </p>
          <Link
            href="/login"
  ...
  return (
    <div>
      ...
      <div className="mb-10">
        <h1 className="text-3xl font-extrabold text-primary tracking-tight leading-tight">Reset password</h1>
        <p className="text-muted text-base mt-2">Enter your email and we&apos;ll send you a reset link</p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              autoFocus
              className="w-full h-[56px] rounded-xl bg-card border border-themed-strong pl-12 pr-5 text-base text-primary placeholder:text-subtle focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500/50 transition-all"
            />
          </div>
        </div>
