  ...
  return (
    <div className="min-h-[100dvh] bg-white flex flex-col animate-page-enter">
      ...
      >
        ...
        <p className="flex-1 text-[17px] font-bold text-surface-900">Complete Payment</p>
        <div className="flex items-center gap-1 text-brand-500">
          <Lock className="h-3.5 w-3.5" />
          <span className="text-[12px] font-semibold">Secure</span>
        </div>
      </div>
      ...
      <div className="flex-1 px-5 py-6 space-y-6">
        ...
        {order && (
          <div className="rounded-2xl shadow-card overflow-hidden">
            <div className="px-4 py-3 bg-surface-50 border-b border-surface-50">
              <div className="flex items-center justify-between">
                <span className="section-label">Order Summary</span>
                <span className="text-[12px] text-surface-400 font-semibold">#{order.orderNumber}</span>
              </div>
            </div>
        ...
        {/* Success */}
        {state === 'success' && (
          <div className="py-8 text-center animate-scale-in-spring">
            <div className="relative inline-flex mb-4">
              <div className="absolute inset-0 rounded-full bg-brand-500/20 blur-xl scale-[2] animate-pulse" />
              <div className="relative h-20 w-20 rounded-full bg-brand-500 flex items-center justify-center">
                <CheckCircle className="h-10 w-10 text-white" />
              </div>
            </div>
            <p className="text-surface-900 text-[18px] font-bold">Payment Successful!</p>
            <p className="text-surface-400 text-[14px] mt-1">Redirecting to your delivery tracking...</p>
          </div>
        )}
