  ...
  return (
    ...
    >
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:h-18 sm:px-8 lg:px-10">
        ...
        {/* Mobile hamburger */}
        <button
          className="inline-flex h-10 w-10 items-center justify-center rounded-xl text-surface-700 transition-colors hover:bg-surface-100 lg:hidden"
    ...
    {/* Mobile menu overlay — outside header to avoid stacking context conflicts */}
    <div
    ...
    {/* Mobile menu panel */}
    <div
      className={`fixed inset-y-0 right-0 z-[70] w-full max-w-sm bg-white shadow-2xl transition-transform duration-500 ease-out lg:hidden ${
