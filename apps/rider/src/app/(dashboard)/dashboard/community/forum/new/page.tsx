  ...
  return (
    <div className="min-h-[100dvh] bg-[#0a0e17]">
        ...
        <div className="px-4 pt-[env(safe-area-inset-top)]">
          <div className="flex items-center justify-between h-14">
            ...
            <button
              ...
              className="text-sm font-semibold text-brand-400 disabled:text-surface-600 px-2 py-1"
            >
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        {/* Category selector */}
        <div>
          <label className="text-xs text-surface-400 font-medium mb-2 block">Category</label>
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-medium transition-all ${
                  category === cat
                    ...
                    : 'bg-white/[0.04] text-surface-400 border border-white/[0.06] hover:bg-white/[0.08]'
                }`}
              >
        ...
        <div>
          <input
            ...
            maxLength={200}
            className="w-full bg-transparent text-lg font-semibold text-white placeholder:text-surface-600 focus:outline-none"
          />
        </div>
        ...
        <div>
          <textarea
            ...
            rows={6}
            className="w-full bg-white/[0.03] border border-white/[0.06] rounded-xl px-4 py-3 text-sm text-white placeholder:text-surface-500 focus:outline-none focus:border-brand-500/50 resize-none"
          />
        </div>
        ...
        {!showPoll ? (
          ...
          <div className="p-4 rounded-2xl bg-purple-500/[0.06] border border-purple-500/20 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setShowPoll(false)} className="text-surface-500 hover:text-surface-300">
                <X className="h-4 w-4" />
              </button>
            </div>
            ...
            <input
              ...
              className="w-full bg-white/[0.04] border border-white/[0.06] rounded-lg px-3 py-2 text-sm text-white placeholder:text-surface-500 focus:outline-none focus:border-purple-500/50"
            />
            ...
            {pollOptions.map((opt, i) => (
              <div key={i} className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 bg-white/[0.04] border border-white/[0.06] rounded-lg px-3 py-2 text-sm text-white placeholder:text-surface-500 focus:outline-none focus:border-purple-500/50"
                />
                {pollOptions.length > 2 && (
                  <button onClick={() => removePollOption(i)} className="text-surface-500 hover:text-red-400">
                    <X className="h-4 w-4" />
                  </button>
                )}
              </div>
