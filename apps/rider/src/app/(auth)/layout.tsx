        ...
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-12 py-16">
          ...
          <div className="text-center auth-slide-up">
            ...
            <p className="max-w-[280px] text-body-sm text-surface-400 leading-relaxed">
              Join thousands of riders across Ghana earning on their own schedule.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="flex items-center justify-between px-5 py-4 lg:hidden">
          ...
          <div className="flex items-center gap-1.5 rounded-full bg-accent-50 px-3 py-1">
            ...
            <span className="text-caption font-medium text-accent-700">Rider</span>
          </div>
        </div>
